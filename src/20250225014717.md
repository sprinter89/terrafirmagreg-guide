...
To make stone tools, pick up some wood sticks and stones fallen around. Make stone tool heads by [knapping](./primitive-age/20250306153529.md#stone-knapping), and craft them with sticks to get stone tools. Stone axe is for chopping a tree, and stone knife is for gathering thatch, which is used for pit kiln.
...
Clay is found under specific types of flowers[^4]. Dig them with shovel you've crafted earlier.

After getting clay, [knap](./primitive-age/20250306153529.md#clay-knapping) them. Clay knapping recipe is similar to inverted stone knapping recipe, with some added tools. It costs 5 clay per recipe and does not consume clay even if you fail to make one.
